 ...
 function Navbar() {
  ...
  useEffect(()=>{
    ...
    const navItems= (
      ...
      <li>
        <Link to="/non">Non-Fiction </Link>
      </li>
      <li>
        <Link to="/child">Children Books </Link>
      </li>
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer ">Librarium</a>
  </div>
...
{/*=============================================search bar=========================================== */}
  ...
  <svg
    ...
    <path
      fillRule="evenodd"
      d="M9.965 11.026a5 5 0 1 1 1.06-1.06l2.755 2.754a.75.75 0 1 1-1.06 1.06l-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0"
      clipRule="evenodd" />
  </svg>
</label>
  </div>
  ...
  {/* =====================================Login button====================================== */}
  <div className="">
    <a className="bg-black text-white p-3  py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" 
    onClick={()=>document.getElementById("my_modal_3").showModal()}>SignUp</a>
